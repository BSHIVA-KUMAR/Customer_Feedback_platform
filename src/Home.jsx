...
const Home = () => {
  ...
  return (
    <Container maxWidth="md" sx={{ mt: 4, backgroundColor: "#f4f4f4", p: 3, borderRadius: 2 }}>
        ...
        <Card sx={{ p: 3, minWidth: 300, borderRadius: 3, backgroundColor: "#ffffff", boxShadow: 6 }}>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
            <Button
              ...
              color="primary"
              fullWidth
              sx={{ borderRadius: 3, textTransform: "none", padding: "8px 16px", fontSize: "14px" }}
            >
              View Feedbacks
            </Button>
            ...
            <Button
              ...
              color="error"
              fullWidth
              sx={{ borderRadius: 3, textTransform: "none", padding: "8px 16px", fontSize: "14px", borderColor: "error.main" }}
            >
              Logout
            </Button>
          </Box>
      ...
      <Card sx={{ p: 4, borderRadius: 3, boxShadow: 3, backgroundColor: "skyblue", mt: 3 }}>
        <CardContent>
